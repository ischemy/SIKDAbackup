...
const FormPenggunaPassChange = () => {
    ...
    const items = [{ label: 'Ganti Password Pengguna' }];
    const home = { label: 'Kembali', url: '/auth/user/user/update' };
                    ...
                    <div className="flex flex-column mt-4">
                        <div className="field">
                            ...
                            <InputText
                                ...
                                required
                                style={{ borderRadius: '99px', width: '335px', marginLeft: '70px' }}
                                autoFocus
...
export default FormPenggunaPassChange;
