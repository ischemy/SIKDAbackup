            ...
            <div className="grid">
                ...
                <div className="col-12 md:col-6">
                    <div className="flex align-items-center flex-wrap gap-9 mb-3">
                        ...
                        <InputText
                            id="nik"
                            style={{ borderRadius: '99px', width: '335px' }}
                            value={practitioner.nik}
                            onChange={(e) => onInputChange(e, 'nik')}
                            required
                            autoFocus
                            className={classNames({
                                'p-invalid flex-auto': submitted && !practitioner.nik
                            })}
                        />
                        <Button style={{ background: '#EBF3FF', color: '#3899FE', border: 'none', width: '80px' }} className="ml-3" label="Cari" onClick={() => searchPractitioner(practitioner.nik)} />

                        {submitted && !practitioner.nik && <small className="p-invalid">Kode is required.</small>}
                    </div>
                    <div className="flex align-items-center flex-wrap gap-9 mb-3">
                        <label htmlFor="nama" className="col-fixed w-14rem required">
                            Nama
                        </label>
                        <InputText
                            id="nama"
                            ...
                            readOnly
                            className={classNames({
                                'p-invalid flex-auto': submitted && !practitioner.name
                            })}
                        />
                    ...
                    <div className="flex align-items-center flex-wrap gap-9 mb-3">
                        ...
                        <InputText
                            ...
                            style={{ borderRadius: '99px', width: '335px' }}
                            className={classNames({
                                'p-invalid flex-auto': submitted && !practitioner.contactDetail.phone
                            })}
                        />
                    </div>
                    <div className="flex align-items-center flex-wrap gap-9 mb-3">
                        <label htmlFor="email" className="col-fixed w-14rem required">
                            E-mail
                        </label>
                        <InputText
                            id="email"
                            ...
                            autoFocus
                            className={classNames({
                                'p-invalid flex-auto': submitted && !practitioner.contactDetail.email
                            })}
                        />
                    </div>
                    <div className="flex align-items-center flex-wrap gap-9 mb-3">
                        <label htmlFor="satusehatId" className="col-fixed w-14rem required">
                            ID SATUSEHAT
                        </label>
                        <InputText
                            id="satusehatId"
                            ...
                            autoFocus
                            className={classNames({
                                'p-invalid flex-auto': submitted && !practitioner.satusehatId
                            })}
                        />
                    </div>
                    <div className="flex align-items-center flex-wrap gap-9 mb-3eld">
                        <label htmlFor="sipNumber" className="col-fixed w-14rem required">
                            No SIP
                        </label>
                        <InputText
                            id="sipNumber"
                            ...
                            autoFocus
                            className={classNames({
                                'p-invalid flex-auto': submitted && !practitioner.sipNumber
                            })}
                        />
                    </div>
                    <div className="flex align-items-center flex-wrap gap-9 mb-3">
                        <label htmlFor="sipIssuer" className="col-fixed w-14rem required">
                            Penerbit SIP
                        </label>
                        <InputText
                            id="sipIssuer"
                            ...
                            autoFocus
                            className={classNames({
                                'p-invalid flex-auto': submitted && !practitioner.sipIssuer
                            })}
                        />
                    </div>
                </div>
                <div className="col-12 md:col-6" style={{ borderLeft: '2px solid #EDEEF1' }}>
                    <div className="flex align-items-center flex-wrap gap-9 mb-3">
                        <label htmlFor="ktpWilayah" className="col-fixed w-14rem required">
                            Alamat KTP
                        </label>
                    ...
                    <div className="flex align-items-center flex-wrap gap-9 mb-3">
                        <label htmlFor="" className="col-fixed w-14rem required">
                            Alamat Jalan
                        </label>
                        <InputText
                            style={{ borderRadius: '99px', width: '335px' }}
                            ...
                            autoFocus
                            className={classNames({
                                'p-invalid flex-auto': submitted && !practitioner.ktpAddress.addressLine
                            })}
                        />
                    </div>

                    <div className="flex align-items-center gap-2 mb-3">
                        <label htmlFor="" className="col-fixed w-3rem required">
                            RT
                        </label>
                        <InputText
                            style={{ borderRadius: '99px', width: '130px' }}
                            id="ktpAddress.rt"
                            ...
                            maxLength={3}
                            className={classNames({
                                'p-invalid flex-auto': submitted && !practitioner.ktpAddress.rt
                            })}
                        />
                        <label htmlFor="" className="col-fixed w-3rem required">
                            RW
                        ...
                        <InputText
                            ...
                            maxLength={3}
                            className={classNames({
                                'p-invalid flex-auto': submitted && !practitioner.ktpAddress.rw
                            })}
                        />
                        <label htmlFor="" className="col-fixed w-3rem required">
                            Kode POS
                    ...
                    <div className="flex align-items-center flex-wrap gap-9 mb-3">
                        ...
                        <InputNumber maxLength={6} style={{ borderRadius: '99px', width: '335px' }} id="ktpAddress.longitude" value={practitioner.ktpAddress?.longitude} onChange={(e) => onInputNumberChange(e, 'ktpAddress.longitude')} />
                    </div>
                    ...
                    <div className="flex align-items-center flex-wrap gap-9 mb-3">
                        ...
                        <InputNumber maxLength={6} style={{ borderRadius: '99px', width: '335px' }} id="ktpAddress.latitude" value={practitioner.ktpAddress?.latitude} onChange={(e) => onInputNumberChange(e, 'ktpAddress.latitude')} />
                    </div>

                    <div className="flex align-items-center flex-wrap gap-9 mb-3">
                        <label htmlFor="isSameKTPResidence" className="col-fixed w-14rem required">
                    ...
                    {!practitioner.isSameKTPResidence && (
                        <>
                            <div className="flex align-items-center flex-wrap gap-9 mb-3">
                                <label htmlFor="domisiliWilayahId" className="col-fixed w-14rem required">
                                    Alamat Domisili
                                </label>
                                <AutoComplete
                            ...
                            <div className="flex align-items-center flex-wrap gap-9 mb-3">
                                ...
                                <InputText
                                    ...
                                    autoFocus
                                    className={classNames({
                                        'p-invalid flex-auto': submitted && !practitioner.residenceAddress.addressLine
                                    })}
                                />
                            </div>
                            ...
                            <div className="flex align-items-center gap-2 mb-3">
                                ...
                                <InputText
                                    ...
                                    maxLength={3}
                                    className={classNames({
                                        'p-invalid flex-auto flex-auto': submitted && !practitioner.residenceAddress.rt
                                    })}
                                />
