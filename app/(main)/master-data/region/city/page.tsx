...
const CityPage = () => {
    const [wilayahs, setWilayahs] = useState<City[]>([]);
    ...
    useEffect(() => {
        setIsLoading(true);
        RegionService.getCity(searchTerm, page, perPage)
            .then((response) => {
    ...
    return (
        <div className="grid crud-demo">
            <div className="col-12">
                <div className="card">
                    <Toast ref={toast} />
                    <h5 className="m-0">Wilayah - Kabupaten/Kota</h5>
                    ...
                    >
                        ...
                        <Column field="partOfRegion.code" header="Kode Provinsi" sortable headerStyle={{ minWidth: '15rem' }}></Column>
                        <Column field="partOfRegion.text" header="Nama Provinsi" sortable headerStyle={{ minWidth: '15rem' }}></Column>
                        <Column field="code" header="Kode Kabupaten/Kota" sortable headerStyle={{ minWidth: '15rem' }}></Column>
                        <Column field="text" header="Nama Kabupaten/Kota" sortable headerStyle={{ minWidth: '15rem' }}></Column>
                    </DataTable>
                </div>
            </div>
        </div>
