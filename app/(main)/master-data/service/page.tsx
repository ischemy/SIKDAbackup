    ...
    const header = (
        <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-end">
            <span className="block mt-2 md:mt-0 p-input-icon-left">
                ...
                <InputText style={{ borderRadius: '99px', width: '335px' }} type="search" onInput={(e) => setGlobalFilter(e.currentTarget.value)} placeholder="Search..." />
                <Button style={{ background: '#EBF3FF', color: '#3899FE', border: 'none', width: '80px' }} className="ml-3" label="Cari" />
            </span>
            <Button label="Tambah Layanan" icon="pi pi-plus" severity="info" className=" mr-2" onClick={openNew} />
        </div>
    );
    ...
    return (
        <div className="grid crud-demo">
            <div className="col-12">
                <div className="card">
                    <Toast ref={toast} />
                    <h5 className="col-2">Kelola Layanan</h5>
